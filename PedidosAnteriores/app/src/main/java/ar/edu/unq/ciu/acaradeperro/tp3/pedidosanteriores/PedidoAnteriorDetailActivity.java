...
/**
 * An activity representing a single Pedido Anterior detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link PedidoAnteriorListActivity}.
 */
public class PedidoAnteriorDetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, PedidoAnteriorListActivity.class));
            return true;
        }
